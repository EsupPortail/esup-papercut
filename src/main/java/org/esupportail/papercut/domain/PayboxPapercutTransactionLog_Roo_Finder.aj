...
privileged aspect PayboxPapercutTransactionLog_Roo_Finder {
    ...
    public static Long PayboxPapercutTransactionLog.countFindPayboxPapercutTransactionLogsByUidEqualsAndPaperCutContextEqualsAndArchived(String uid, String paperCutContext, Boolean archived) {
        if (uid == null || uid.length() == 0) throw new IllegalArgumentException("The uid argument is required");
        if (paperCutContext == null || paperCutContext.length() == 0) throw new IllegalArgumentException("The paperCutContext argument is required");
        if (archived == null) throw new IllegalArgumentException("The archived argument is required");
        EntityManager em = PayboxPapercutTransactionLog.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM PayboxPapercutTransactionLog AS o WHERE o.uid = :uid  AND o.paperCutContext = :paperCutContext  AND o.archived = :archived", Long.class);
        q.setParameter("uid", uid);
        q.setParameter("paperCutContext", paperCutContext);
        q.setParameter("archived", archived);
        return ((Long) q.getSingleResult());
    ...
    public static TypedQuery<PayboxPapercutTransactionLog> PayboxPapercutTransactionLog.findPayboxPapercutTransactionLogsByIdtransEquals(String idtrans) {
        if (idtrans == null || idtrans.length() == 0) throw new IllegalArgumentException("The idtrans argument is required");
        EntityManager em = PayboxPapercutTransactionLog.entityManager();
        TypedQuery<PayboxPapercutTransactionLog> q = em.createQuery("SELECT o FROM PayboxPapercutTransactionLog AS o WHERE o.idtrans = :idtrans", PayboxPapercutTransactionLog.class);
        q.setParameter("idtrans", idtrans);
        return q;
    }
    ...
    public static TypedQuery<PayboxPapercutTransactionLog> PayboxPapercutTransactionLog.findPayboxPapercutTransactionLogsByPaperCutContextEquals(String paperCutContext) {
        if (paperCutContext == null || paperCutContext.length() == 0) throw new IllegalArgumentException("The paperCutContext argument is required");
        EntityManager em = PayboxPapercutTransactionLog.entityManager();
        TypedQuery<PayboxPapercutTransactionLog> q = em.createQuery("SELECT o FROM PayboxPapercutTransactionLog AS o WHERE o.paperCutContext = :paperCutContext", PayboxPapercutTransactionLog.class);
        q.setParameter("paperCutContext", paperCutContext);
        return q;
    }
    ...
    public static TypedQuery<PayboxPapercutTransactionLog> PayboxPapercutTransactionLog.findPayboxPapercutTransactionLogsByUidEqualsAndPaperCutContextEquals(String uid, String paperCutContext) {
        if (uid == null || uid.length() == 0) throw new IllegalArgumentException("The uid argument is required");
        if (paperCutContext == null || paperCutContext.length() == 0) throw new IllegalArgumentException("The paperCutContext argument is required");
        EntityManager em = PayboxPapercutTransactionLog.entityManager();
        TypedQuery<PayboxPapercutTransactionLog> q = em.createQuery("SELECT o FROM PayboxPapercutTransactionLog AS o WHERE o.uid = :uid  AND o.paperCutContext = :paperCutContext", PayboxPapercutTransactionLog.class);
        q.setParameter("uid", uid);
        q.setParameter("paperCutContext", paperCutContext);
        return q;
    }
    ...
    public static TypedQuery<PayboxPapercutTransactionLog> PayboxPapercutTransactionLog.findPayboxPapercutTransactionLogsByUidEqualsAndPaperCutContextEqualsAndArchived(String uid, String paperCutContext, Boolean archived) {
        if (uid == null || uid.length() == 0) throw new IllegalArgumentException("The uid argument is required");
        if (paperCutContext == null || paperCutContext.length() == 0) throw new IllegalArgumentException("The paperCutContext argument is required");
        if (archived == null) throw new IllegalArgumentException("The archived argument is required");
        EntityManager em = PayboxPapercutTransactionLog.entityManager();
        TypedQuery<PayboxPapercutTransactionLog> q = em.createQuery("SELECT o FROM PayboxPapercutTransactionLog AS o WHERE o.uid = :uid  AND o.paperCutContext = :paperCutContext  AND o.archived = :archived", PayboxPapercutTransactionLog.class);
        q.setParameter("uid", uid);
        q.setParameter("paperCutContext", paperCutContext);
        q.setParameter("archived", archived);
        return q;
    ...
    public static TypedQuery<PayboxPapercutTransactionLog> PayboxPapercutTransactionLog.findPayboxPapercutTransactionLogsByUidEqualsAndPaperCutContextEqualsAndArchived(String uid, String paperCutContext, Boolean archived, String sortFieldName, String sortOrder) {
        if (uid == null || uid.length() == 0) throw new IllegalArgumentException("The uid argument is required");
        if (paperCutContext == null || paperCutContext.length() == 0) throw new IllegalArgumentException("The paperCutContext argument is required");
        if (archived == null) throw new IllegalArgumentException("The archived argument is required");
        EntityManager em = PayboxPapercutTransactionLog.entityManager();
