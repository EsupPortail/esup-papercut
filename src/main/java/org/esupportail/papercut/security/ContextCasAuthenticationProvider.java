...
InitializingBean, MessageSourceAware {
	...
	private static final Log logger = LogFactory.getLog(ContextCasAuthenticationProvider.class);
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		...
		if (authentication instanceof ContextCasAuthenticationToken) {
			if (this.key.hashCode() != ((ContextCasAuthenticationToken) authentication).getKeyHash()) {
				throw new BadCredentialsException(this.messages.getMessage("ContextCasAuthenticationToken.incorrectKey",
		...
		if (stateless) {
			...
			result = (ContextCasAuthenticationToken)this.statelessTicketCache.getByTicketId(authentication.getCredentials().toString());
		}
		if (result == null) {
	 ...
	 * {@link org.springframework.security.cas.authentication.ServiceAuthenticationDetails}, then
	 * {@link org.springframework.security.cas.authentication.ServiceAuthenticationDetails#getServiceUrl()} is used. Otherwise, the
	...
	private String getServiceUrl(Authentication authentication) {
		String serviceUrl;
		if (authentication.getDetails() instanceof org.springframework.security.cas.authentication.ServiceAuthenticationDetails) {
